...
-> Now travese the entire array and if arr[k]!=arr[i] that is arr[i] is a unique value hence it should be included
   so increment the k and swap arr[k] with arr[i]
